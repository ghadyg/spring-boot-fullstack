    ...
    return (
      <Formik
        ...
        validationSchema={Yup.object({
          ...
          password:Yup.string().max(30,"password cannot be more than 20 characters")
        ...
        onSubmit={(values,{setSubmitting})=>{
          ...
          {({isValid,isSubmitting})=>(
            <Form>
              <Stack spacing={15}>
                <MyTextInput label={"Email"} name= {"username"} type= {"email"} placeholder={"hello@examole.com"}/>

                <MyTextInput label={"Passowrd"} name= {"password"} type= {"password"} placeholder={"Type your passord"}/>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack spacing={4} w={'full'} maxW={'md'}>
            ...
            <LoginForm/>
            <Link color={"blue.500"} href='/signup'>Dont have an account? Sign up now.</Link>
          </Stack>
        </Flex>
