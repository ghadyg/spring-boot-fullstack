package com.fullStackCourse.security;

import com.fullStackCourse.Exception.DelegatedAuthEntryPoint;
import com.fullStackCourse.jwt.JWTAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth ->
                        ...
                        .requestMatchers(HttpMethod.GET,"/ping","/api/v1/customers/*/profile-image").permitAll()
